...
class WaterController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('water.index', compact('readings', 'locations'));
    }
    ...
    public function create()
    {
        ...
        return view('water.create', compact('locations', 'previousValues'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            foreach ($request->readings as $readingData) {
                if ($readingData['current_value'] === null || $readingData['current_value'] === '') {
                    continue;
                }
            ...
            return redirect()->route('water.index')
                ->with('success', 'Data pembacaan meter air berhasil disimpan.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function edit(string $date)
    {
        ...
        return view('water.edit', compact('locations', 'readings', 'date', 'previousValues'));
    }
    ...
    public function update(Request $request, string $date)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('water.index')
                ->with('success', 'Data pembacaan meter air berhasil diperbarui.');
        } catch (\Exception $e) {
            DB::rollBack();
            return back()->withErrors(['error' => 'Terjadi kesalahan: ' . $e->getMessage()])->withInput();
        }
    ...
    public function destroy(string $date)
    {
        ...
        return redirect()->route('water.index')
            ->with('success', 'Data pembacaan meter air berhasil dihapus.');
    }
}
