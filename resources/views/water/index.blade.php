...
@section('title', 'Checklist Air')

@section('content_header')
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
    <h1 class="mb-2 mb-md-0"><i class="fas fa-tint text-info"></i> Checklist Air</h1>
    <a href="{{ route('water.create') }}" class="btn btn-primary">
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Data Pembacaan Meter Air</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('water.edit', $date) }}" class="btn btn-info" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('water.destroy', $date) }}" method="POST" class="d-inline"
        ...
        @forelse($readings as $date => $dateReadings)
            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-header bg-light d-flex justify-content-between align-items-center py-2">
                    ...
                    <div class="btn-group btn-group-sm">
                        <a href="{{ route('water.edit', $date) }}" class="btn btn-info btn-sm">
                            <i class="fas fa-edit"></i>
                        </a>
                        <form action="{{ route('water.destroy', $date) }}" method="POST" class="d-inline"
