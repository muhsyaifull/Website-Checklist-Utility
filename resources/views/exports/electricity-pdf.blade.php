...
<head>
    <meta charset="utf-8">
    <title>Electricity Meter Reading Data</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 10mm;
...
<body>
    <h1>Electricity Meter RAI Reading Data</h1>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="2" style="width: 100px;">Previous Meter<br>Reading (kWh)</th>
                <th colspan="{{ count($locations) }}" class="header-group">Meter Reading (kWh)</th>
                <th rowspan="2" style="width: 80px;">Daily Electricity<br>Use (kWh)</th>
            </tr>
            <tr>
